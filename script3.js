...
window.onload = () => {
    ...
    document.getElementById('submitBtn').addEventListener('click', async () => {
        ...
        if (file && runtime) {
            // Hide the file name or adjust UI before processing starts
            document.getElementById('processingMessage').style.display = 'block'; // Show processing message
            // Optionally, hide the file input if you don't want it to be visible during processing
            // fileInput.style.visibility = 'hidden';
            // fileInput.blur(); // Remove focus from the file input
            // fileInput.value = ''; // Clear the file input value if you want to allow another file to be selected
            resetInputs()
...
output
    ...
    function resetInputs() {
        ...
        document.getElementById('runtimeSelect').value = ''; // Reset dropdown to default value
        document.getElementById('columnNamesInput').value = ''; // Clear column names input
    }
};
